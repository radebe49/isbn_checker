# ============================================================
# LEVEL 1 - bare calculation logic (where we are now)
# no imports, no validation, just the maths
# ============================================================

def check_digit(isbn):
    # isbn is first 9 digits as a string
...
def validate_isbn10(isbn):
    # multiply each digit by its position (1 to 10), sum, check mod 11
    total = 0
    for i in range(10):
        if isbn[i] == "X":
            total = total + 10 * 10
